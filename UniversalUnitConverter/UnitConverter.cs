...
using UniversalUnitConverter.Units.Length;
#endregion
namespace UniversalUnitConverter
{
    ...
    public static class UnitConverter
    {
        ...
        public static BigDecimal Convert ( decimal value , LengthUnit fromUnit , LengthUnit toUnit ) => value * ( Length.Value ( fromUnit ) / Length.Value ( toUnit ) );
        #endregion
    }
}
