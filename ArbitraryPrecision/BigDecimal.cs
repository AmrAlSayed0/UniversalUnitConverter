...
namespace ArbitraryPrecision
{
    ...
    public struct BigDecimal : IFormattable , IComparable , IComparable < BigDecimal > , IEquatable < BigDecimal >
    {
        ...
        static readonly Regex _relaxedParsePattern = new Regex ( @"(?imsx:
        ...
        static readonly Regex _standardNumericFormatPattern = new Regex ( @"^(?i:(?<FormatSpecifier>[CcDdEeFfGgNnPpRrXx]))(?<PrecisionSpecifier>[0-9]*)$" );
        ...
        static readonly Regex _customNumericFormatPattern = new Regex ( "^$" );
        /// <summary>A decimal whose value is zero (0).</summary>
        static readonly BigDecimal _zero = new BigDecimal
                                           {
        ...
        static readonly BigDecimal _one = new BigDecimal
                                          {
                                              _currentContext = BigDecimalContext.DefaultContext ,
                                              _sign = 1 ,
                                              _mantissa = 1 ,
        ...
        static readonly BigDecimal _minusOne = new BigDecimal
                                               {
                                                   _currentContext = BigDecimalContext.DefaultContext ,
                                                   _sign = - 1 ,
                                                   _mantissa = - 1 ,
        ...
        static readonly BigDecimal _positiveInfinity = new BigDecimal
                                                       {
        ...
        static readonly BigDecimal _negativeInfinity = new BigDecimal
                                                       {
        ...
        static readonly BigDecimal _negativeZero = new BigDecimal
                                                   {
        ...
        static readonly BigDecimal _nan = new BigDecimal
                                          {
        ...
        BigInteger _mantissa;
        /// <summary>The exponent part of the number.</summary>
        BigInteger _exponent;
        /// <summary>A number that indicates the sign of the <see cref = "BigDecimal" />, as shown in the following table: <list type = "table" ><listheader><term>Number</term> <term>Description</term></listheader> <item><term>-1</term> <term>The value of this <see cref = "BigDecimal" /> is negative.</term></item> <item><term>0</term> <term>The value of this <see cref = "BigDecimal" /> is 0 (zero) or NaN (Not-a-Number).</term></item> <item><term>1</term> <term>The value of this <see cref = "BigDecimal" /> is positive.</term></item></list></summary>
        int _sign;
        /// <summary>Specifies the context (settings) for the current <see cref = "BigDecimal" /> struct.</summary>
        BigDecimalContext _currentContext;
        ...
        static Regex StandardNumericFormatPattern => _standardNumericFormatPattern;
        ...
        static Regex CustomNumericFormatPattern => _customNumericFormatPattern;
        //TODO: Deprecate and implement the IFormatProvider and the NumberStyles format.
        ...
        static Regex RelaxedParsePattern => _relaxedParsePattern;
        ...
        public BigInteger Mantissa
        {
            ...
            set
            {
                if ( ! this.IsSpecialValue )
                {
                    ...
                    this._sign = this._mantissa.Sign;
                }
                else
                {
                    this._mantissa = BigInteger.Zero;
                }
            }
        }
        ...
        public BigInteger Exponent
        {
            ...
            set
            {
                ...
                {
                    this._exponent = BigInteger.Zero;
                }
            }
        }
        ...
        /// <value>A number that indicates the sign of the <see cref = "BigDecimal" /> object, as shown in the following table: <list type = "table" ><listheader><term>Number</term> <term>Description</term></listheader> <item><term>-1</term> <term>The value of this <see cref = "BigDecimal" /> is negative.</term></item> <item><term>0</term> <term>The value of this <see cref = "BigDecimal" /> is 0 (zero) or NaN (Not-a-Number).</term></item> <item><term>1</term> <term>The value of this <see cref = "BigDecimal" /> is positive.</term></item></list></value>
                ...
                if ( ! this.IsSpecialValue )
                {
                    if ( value < 0 )
                    {
                        ...
                        else
                        {
                            ...
                            {
                                this._sign = - 1;
                                this._mantissa = - BigInteger.Abs ( this.Mantissa );
                            }
                        }
                    }
                    else if ( value > 0 )
        ...
        {
            get => this._currentContext;
            set
            {
                if ( ! value.Equals ( this._currentContext ) )
                {
        ...
        public bool IsInteger
        {
            get
            {
                if ( this.IsSpecialValue )
                {
                    this._isInteger = /*this.IsPositiveZero ||*/
                    this.IsNegativeZero;
                }
                else
                {
                    this._isInteger = this.Exponent >= 0;
                }
        ...
        public bool IsEven
        {
            get
            {
                if ( this.IsSpecialValue )
                {
                    this._isEven = /*this.IsPositiveZero ||*/
                    this.IsNegativeZero;
                }
                else
                {
                    ...
                    else
                    {
                        if ( this.Exponent == 0 )
                        {
                            this._isEven = ( this.Mantissa.LastDigit () % 2 ) == 0;
                        }
                        else
                        {
                            this._isEven = true;
            ...
            get
            {
                ...
                else
                {
                    ...
                    else
                    {
                        if ( this.Exponent == 0 )
                        {
                            this._isOdd = ( this.Mantissa.LastDigit () % 2 ) != 0;
                        }
                        else
                        {
                            this._isOdd = false;
        ...
        public bool IsPositiveInfinity => ( this.Mantissa == BigInteger.Zero ) && ( ( this.Exponent == BigInteger.Zero ) & ( this.Sign > 0 ) ) && this.CurrentContext.Equals ( PositiveInfinity.CurrentContext );
        ...
        public bool IsNegativeInfinity => ( this.Mantissa == BigInteger.Zero ) && ( ( this.Exponent == BigInteger.Zero ) & ( this.Sign < 0 ) ) && this.CurrentContext.Equals ( NegativeInfinity.CurrentContext );
        ...
        public bool IsNegativeZero => ( this.Mantissa == BigInteger.Zero ) && ( ( this.Exponent == BigInteger.Zero ) & ( this.Sign < 0 ) ) && this.CurrentContext.Equals ( NegativeZero.CurrentContext );
        ...
        public bool IsNaN => ( this.Mantissa == BigInteger.Zero ) && ( ( this.Exponent == BigInteger.Zero ) & ( this.Sign == 0 ) ) && this.CurrentContext.Equals ( NaN.CurrentContext );
        #endregion
        ...
        : this ()
        {
            ...
            if ( ! this.CurrentContext.IsSpecialValue )
            {
                this.Normalize ();
                this.Round ();
            }
            else
            {
                ...
                switch ( context.ValueType )
                {
                    ...
                    case BigDecimalValues.NaN :
                        this = NaN;
                        break;
                    default : throw new ArgumentException ( "Argument is of unknown value" , nameof ( context ) );
                }
            }
        }
        ...
        public static int Compare ( BigDecimal left , BigDecimal right ) => left.CompareTo ( right );
        ...
        public static BigDecimal Add ( BigDecimal left , BigDecimal right ) => left + right;
        ...
        public static BigDecimal Subtract ( BigDecimal left , BigDecimal right ) => left - right;
        ...
        public static BigDecimal Multiply ( BigDecimal left , BigDecimal right ) => left * right;
        ...
        public static BigDecimal Negate ( BigDecimal value ) => - value;
        ...
        public static BigDecimal Exp ( BigDecimal power )
        {
            if ( ! power.IsSpecialValue )
            {
                ...
                if ( _maxN <= 0 )
                {
                    throw new ArgumentOutOfRangeException ( nameof ( _maxN ) , _maxN , "Powers must not be a negative number or zero." );
                }
                if ( _maxN == 1 )
                {
                    endResult = One;
        ...
        public static BigDecimal Pow ( BigDecimal value , BigDecimal exponent ) => Exp ( exponent * Log ( value ) );
        ...
        public static BigDecimal Log ( BigDecimal value , BigDecimal baseValue ) => Log ( value ) / Log ( baseValue );
        /// <summary>Returns the base 10 logarithm of a specified number.</summary>
        /// <exception cref = "System.ArgumentOutOfRangeException" >.</exception>
        /// <exception cref = "System.ArgumentException" >.</exception>
        /// <param name = "value" >The value to calculate the logarithm of.</param>
        /// <returns>The base 10 logarithm of <paramref name = "value" ></paramref>.</returns>
        public static BigDecimal Log10 ( BigDecimal value ) => Log ( value ) / Log ( 10 );
        ...
        public static BigDecimal Parse ( string number ) => Parse ( number , BigDecimalContext.DefaultContext );
        /// <summary>Converts the string representation of a number to its BigDecimal equivalent.</summary>
        /// <exception cref = "ArgumentException" >.</exception>
        /// <param name = "number" >The string to parse.</param>
        ...
        public static BigDecimal Parse ( string value , NumberStyles style ) => throw new NotImplementedException ();
        ...
        public static BigDecimal Parse ( string value , IFormatProvider provider ) => throw new NotImplementedException ();
        ...
        /// <param name = "sign" >A number that indicates the sign of the <see cref = "BigDecimal" /> object, as shown in the following table: <list type = "table" ><listheader><term>Number</term> <term>Description</term></listheader> <item><term>-1</term> <term>The value of this <see cref = "BigDecimal" /> object is negative.</term></item> <item><term>0</term> <term>The value of this <see cref = "BigDecimal" /> object is 0 (zero) or NaN (Not-a-Number).</term></item> <item><term>1</term> <term>The value of this <see cref = "BigDecimal" /> object is positive.</term></item></list></param>
        ...
        static BigDecimal RadixNormalize ( string beforeDecimal , string afterDecimal , string sign , string exponentSign , string exponentNum , BigDecimalContext context )
        {
            BigInteger mantissa;
            BigInteger exponent;
            if ( ( beforeDecimal != string.Empty ) &&
                 ( afterDecimal != string.Empty ) )
            {
        ...
        static string FilterInteger ( string toBeFiltered )
        {
        ...
        /// <param name = "toBeFiltered" >to be filtered.</param>
        /// <returns>A string.</returns>
        static string FilterSign ( string toBeFiltered )
        {
            string finalString = toBeFiltered;
            if ( finalString == string.Empty )
            {
        ...
        static BigInteger AlignExponent ( BigDecimal value , BigDecimal reference )
        {
        ...
        static BigInteger MaxPrecision ( BigDecimal first , BigDecimal second ) => second.CurrentContext.Precision > first.CurrentContext.Precision ? second.CurrentContext.Precision : first.CurrentContext.Precision;
        #endregion
        #region Methods
        ...
        public void Round ()
        {
            if ( this.CurrentContext.AlwaysRound )
            {
                switch ( this.CurrentContext.RoundingMethod )
                {
                    ...
                    case BigDecimalRoundingMethod.Round05Up :
                        this.Round05Up ();
                        break;
                    default : goto case BigDecimalRoundingMethod.RoundDown;
                }
            }
        }
        ...
        {
            BigInteger initialLength = CalcHelper.NumberOfDigits ( this.Mantissa );
            BigInteger diff = initialLength - precision;
            if ( diff > 0 )
            {
                this.DiscardDigits ( diff );
            }
        }
        ...
        {
            this.RoundDown ( this.CurrentContext.Precision );
        }
        ...
        public void RoundHalfUp ( BigInteger precision )
        {
            while ( true )
            {
                ...
                if ( diff > 0 )
                {
                    ...
                    this.DiscardDigits ( diff , ref lastDigit );
                    if ( lastDigit >= 5 )
                    {
                    ...
                    if ( CalcHelper.NumberOfDigits ( this.Mantissa ) > precision )
                    {
                        continue;
                    }
                }
        ...
        {
            this.RoundHalfUp ( this.CurrentContext.Precision );
        }
        ...
        public void RoundHalfEven ( BigInteger precision )
        {
            while ( true )
            {
                ...
                if ( diff > 0 )
                {
                    this.DiscardDigits ( diff , out BigDecimal discardedDigitsAsDecimal , out BigInteger _ );
                    ...
                    if ( discardedDigitsAsDecimal == 0.5 )
                    {
                        if ( ! this.Mantissa.LastDigit ().IsEven )
                        {
                            if ( this.Mantissa.Sign < 0 )
                            {
                                this.Mantissa--;
        ...
        {
            this.RoundHalfEven ( this.CurrentContext.Precision );
        }
        ...
        {
            this.RoundCeiling ( this.CurrentContext.Precision );
        }
        ...
        {
            this.RoundFloor ( this.CurrentContext.Precision );
        }
        ...
        {
            this.RoundHalfDown ( this.CurrentContext.Precision );
        }
        ...
        public void RoundUp ()
        {
            this.RoundUp ( this.CurrentContext.Precision );
        }
        ...
        {
            this.Round05Up ( this.CurrentContext.Precision );
        }
        /// <summary>Discard digits.</summary>
        /// <param name = "diff" >The difference.</param>
        void DiscardDigits ( BigInteger diff )
        {
            for ( int i = 0; i < diff; i++ )
            {
                this.Mantissa = BigInteger.Divide ( this.Mantissa , 10 );
                this.Exponent++;
            }
        }
        /// <summary>Discard digits.</summary>
        ...
        void DiscardDigits ( BigInteger diff , ref BigInteger lastDigit )
        {
            for ( int i = 0; i < diff; i++ )
            {
                if ( i == ( diff - 1 ) )
                {
                    this.Mantissa = BigInteger.DivRem ( this.Mantissa , 10 , out lastDigit );
                }
                else
                {
                    this.Mantissa = BigInteger.Divide ( this.Mantissa , 10 );
        ...
        /// <param name = "lastDigit" >[out] The last digit.</param>
        void DiscardDigits ( BigInteger diff , out BigDecimal discardedDigitsAsDecimal , out BigInteger lastDigit )
        {
        ...
        /// <returns>A value that indicates the relative order of the <see cref = "BigDecimal" />s being compared. The return value has the following meanings: <list type = "table" ><listheader><term>Value</term> <term>Meaning</term></listheader> <item><term>Less than zero</term> <term>This <see cref = "BigDecimal" /> is less than the <paramref name = "obj" /> parameter.</term></item> <item><term>Zero</term> <term>This <see cref = "BigDecimal" /> is equal to <paramref name = "obj" />.</term></item> <item><term>Greater than zero</term> <term>This <see cref = "BigDecimal" /> is greater than <paramref name = "obj" />.</term></item></list></returns>
        ...
        /// <returns>A value that indicates the relative order of the <see cref = "BigDecimal" />s being compared. The return value has these meanings: <list type = "table" ><listheader><term>Value</term> <term>Meaning</term></listheader> <item><term>Less than zero</term> <term>This <see cref = "BigDecimal" /> precedes <paramref name = "other" /> in the sort order.</term></item> <item><term>Zero</term> <term>This <see cref = "BigDecimal" /> occurs in the same position in the sort order as <paramref name = "other" />.</term></item> <item><term>Greater than zero</term> <term>This <see cref = "BigDecimal" /> follows <paramref name = "other" /> in the sort order.</term></item></list></returns>
        ...
        //TODO: Support "Standard Numeric Format" and "Custom Numeric Format" and the "IFormatProvider".
        //TODO: Support special values.
        public string ToString ( string format ) => string.Concat ( this.Mantissa.ToString () , "E" , this.Exponent );
        ...
        public string ToString ( string format , IFormatProvider formatProvider )
        {
            ...
            if ( this.Exponent > 0 )
            {
                return string.Concat ( this.Mantissa.ToString () , new string ( '0' , ( int ) this.Exponent ) );
            }
            if ( this.Exponent == 0 )
            {
            ...
            if ( this.Exponent < 0 )
            {
                int numOfDigits = CalcHelper.NumberOfDigits ( this.Mantissa );
                BigInteger absExponent = BigInteger.Abs ( this.Exponent );
                if ( absExponent < numOfDigits )
                {
                    if ( this.Mantissa.Sign > 0 )
                    {
                        return this.Mantissa.ToString ().Insert ( ( int ) ( numOfDigits - absExponent ) , "." );
                    }
                    if ( this.Mantissa.Sign < 0 )
                    {
                        return this.Mantissa.ToString ().Insert ( ( int ) ( ( numOfDigits - absExponent ) + 1 ) , "." );
                    }
                }
                else if ( absExponent >= numOfDigits )
                {
                    if ( this.Mantissa.Sign > 0 )
                    {
                        return string.Concat ( "0." , new string ( '0' , ( int ) ( absExponent - numOfDigits ) ) , this.Mantissa );
                    }
                    if ( this.Mantissa.Sign < 0 )
                    {
                        return string.Concat ( "-0." , new string ( '0' , ( int ) ( absExponent - numOfDigits ) ) , this.Mantissa );
        ...
        public override int GetHashCode ()
        {
            unchecked
            {
                return ( int ) ( ( this.Mantissa.GetHashCode () * 13 ) ^ this.Exponent );
            }
        }
        #endregion
        ...
        {
            //Updated to support special values
            if ( ! left.IsSpecialValue &&
                 ! right.IsSpecialValue )
            {
        ...
        public static BigDecimal operator * ( BigDecimal left , BigDecimal right )
        {
                 ...
                 right.IsSpecialValue )
            {
                ...
                if ( ( left.IsNegativeZero /*)*/ && ( right.IsPositiveInfinity || right.IsNegativeInfinity ) ) ||
                     ( right.IsNegativeZero /*)*/ && ( left.IsPositiveInfinity || left.IsNegativeInfinity ) ) )
                {
                    //throw new InvalidOperationException ( "Cannot multiply 0 by Infinity." );
                    return NaN;
                }
        ...
        {
            if ( ! dividend.IsSpecialValue &&
                 ! divisor.IsSpecialValue )
            {
                if ( divisor.IsZero )
                {
                    if ( dividend.Sign < 0 )
        ...
        /// <returns>A value that indicates the relative order of the objects being compared. The return value has these meanings: <list type = "table" ><listheader><term>Value</term> <term>Meaning</term></listheader> <item><term>Less than zero</term> <term>This instance precedes <paramref name = "obj" /> in the sort order.</term></item> <item><term>Zero</term> <term>This instance occurs in the same position in the sort order as <paramref name = "obj" />.</term></item> <item><term>Greater than zero</term> <term>This instance follows <paramref name = "obj" /> in the sort order.</term></item></list></returns>
        /// <seealso cref = "IComparable.CompareTo(object)" />
        ...
        /// <returns>A value that indicates the relative order of the <see cref = "BigDecimal" />s being compared. The return value has these meanings: <list type = "table" ><listheader><term>Value</term> <term>Meaning</term></listheader> <item><term>Less than zero</term> <term>This <see cref = "BigDecimal" /> precedes <paramref name = "other" /> in the sort order.</term></item> <item><term>Zero</term> <term>This <see cref = "BigDecimal" /> occurs in the same position in the sort order as <paramref name = "other" />.</term></item> <item><term>Greater than zero</term> <term>This <see cref = "BigDecimal" /> follows <paramref name = "other" /> in the sort order.</term></item></list></returns>
        /// <seealso cref = "BigDecimal.CompareTo(BigDecimal)" />
        int IComparable < BigDecimal >.CompareTo ( BigDecimal other ) => this.CompareTo ( other );
        #endregion
        ...
        /// <returns><c>true</c> if the current <see cref = "BigDecimal" /> is equal to the <paramref name = "other" /> parameter; otherwise, <c>false</c>.</returns>
        /// <seealso cref = "BigDecimal.Equals(BigDecimal)" />
        bool IEquatable < BigDecimal >.Equals ( BigDecimal other ) => this.Equals ( other );
        #endregion
        ...
        //TODO: Support "Standard Numeric Format" and "Custom Numeric Format" and the "IFormatProvider".
        //TODO: Support special values.
        string IFormattable.ToString ( string format , IFormatProvider formatProvider ) => this.ToString ( format , formatProvider );
        #endregion
    }
}
